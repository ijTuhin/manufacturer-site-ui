...
const Footer = () => {
    return (
        <div className='py-10 bg-white border-t-2 grid grid-cols-5'>
            <div className='md:flex md:justify-center md:items-start md:ml-10 col-span-1'>
            ...
            <div className='md:flex md:justify-center md:items-start md:mx-56 col-span-4'>
                <div className='mx-6'>
