        ...
        <div className='my-10 py-10 bg-sky-100'>
            ...
            <div className='md:flex md:justify-center md:items-center md:mx-56 grid grid-cols-2 gap-y-5 gap-x-3 mx-6 my-12'>
                <div>
                    ...
                    <small>Our strong team of over 5000+ employees are working relentlessly in almost all 64 districts of the country with a mission to generate substantial stakeholder value.</small>
                </div>
                <div>
                    ...
                    <small>At over 20 factories and industrial zones in Bangladesh, Zaman Group proudly owns over 1,000,000 square feet of factory space in various parts of the country.</small>
                </div>
                <div>
                    ...
                    <small>In order the become to the largest global brand electronics retailer in the country, Zaman Group is targeting exponential growth in terms of retail space acquisition.</small>
                </div>
                <div>
                    <img src={units} className="w-16" alt=''/>
                    <h1 className='text-4xl text-sky-600 font-medium'>15</h1>
                    <p className='text-xl'>Units</p>
                    <small>Over the years, the visionary leadership of the Managing Director and his concrete ambitions have made Zaman Group a conglomerate with over 15 different unis.</small>
                </div>
            </div>
        </div>
    );
