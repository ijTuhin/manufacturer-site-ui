...
const BusinessSummary = () => {
    return (
        <div className='py-10 bg-sky-100'>
            ...
            <div className='md:flex md:justify-center md:items-center md:mx-56 grid grid-cols-2 gap-y-5 gap-x-3 mx-[10%] my-12'>
                ...
                <div className='flex flex-col justify-center items-center px-2'>
                    <img src={factory} className="w-16" alt=''/>
                ...
                <div className='flex flex-col justify-center items-center px-2'>
                    <img src={retails} className="w-14" alt=''/>
