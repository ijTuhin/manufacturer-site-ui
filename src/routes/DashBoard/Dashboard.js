...
const Dashboard = () => {
    ...
    return (
        <div>
            ...
            {/* ======== Mobile responsive ======== */}
            <div className='md:hidden w-full h-full bg-slate-200'>
                <Outlet />
            </div>
                    ...
                    <div>
                        <ul className="relative px-1">
...

                            {
                                ...
                                <>
                                    <li className="relative">
                                        <Link to='/dashboard/purchase/:id' className="flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out" href="#!" data-mdb-ripple="true" data-mdb-ripple-color="primary">
